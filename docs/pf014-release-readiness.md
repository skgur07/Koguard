...
현재 tuning 1,935건 결과와 공개 synthetic regression은 구현 근거이며 hidden 품질 수치를 대체하지
않는다. balanced는 strict 대비 문장 FP 증분 0을 유지했지만 두 profile 공통 문장 FP 2건이 있고
occurrence FP가 6건 늘어 전체 FP 증분 0 gate를 통과하지 못했다. 이 상태도 최종 release report에서
